...
@Component({
  selector: "app-dynamic-verify-patientotp",
  templateUrl: "./dynamic-patientotp.component.html",
  styleUrls: ["./dynamic-patientotp.component.scss"],
})
export class DynamicPatientOtpComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DynamicPatientOtpComponent>,
  ...
  saveForm() {
    ...
    this.onboardService.managerVerifyOtponPhoneNo(bodyObj).subscribe(
      (res) => {
  ...
  resendOtp() {
    ...
    this.onboardService.sendOtponManagerPhoneNo({userId:this.patientData.userId}).subscribe(
      (res) => {
        this.toaster.showSuccess(
          this.vref,
